...
- Símbolos de dado que faltan por implementar: caras que quitan recursos o cartas (de la mano) al rival: ahora es SPEC-029 (docs/specs/029-disrupt-y-descarte.md), creada el 2026-07-24. Se deja esta línea hasta que se marque completada tras el playtest.
